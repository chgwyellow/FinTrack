...
管理股利與損益表項目，讓投資收入可以與其他財務資訊一起查看。損益表
每個區段最多支援大項目與一層明細；明細也可以選擇不連結帳戶、連結既有
帳戶，或使用自訂帳戶名稱。
...
- **淨值歷史** — 建立手動與定時快照，可左右瀏覽歷史資料，Y 軸會依目前
  顯示區間調整
